package de.mpicbg.sweng.mondrian;//package org.rosuda.Mondrian;
...
/** sorted words: like words, but sorted
 sorted list is not a class attribute for speed reasons */
    ...
    /**
     * NA (j,i) = (column, line) saves missings (missings = NA or NaN) if true: element (i,j) is a missing one else: not
     * a missing
     */
    public boolean[][] NA;
     ...
     * discret values in a column NOTE: first element, which is 0 in a column, indicates the end of a column in
     * wordCount -> see wordStackSize[] public
     */
